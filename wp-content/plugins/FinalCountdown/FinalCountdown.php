...
function FinalCountdown_activation(){
    global $wpdb;
    $wpdb->query("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}countdown (id INT AUTO_INCREMENT PRIMARY KEY,
...
function FinalCountdown_deactivation(){
    ...
    $wpdb->query("DROP TABLE IF EXISTS wordpress.{$wpdb->prefix}countdown;");
